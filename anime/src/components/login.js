...
const Login = () => {
    ...
    <div className ="intro">
        <div className="panel-landing" id="section-1">
            <h1 className="landing-heading">Anime Stream</h1>
            <p>A decentralized anime streaming app <a href="https://blockstack.org" target="_blank" rel="noopener noreferrer">Blockstack</a></p>
            <button
